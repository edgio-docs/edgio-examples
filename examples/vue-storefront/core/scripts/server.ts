...
if (isProd) {
  ...
  const clientManifest = _require(resolve('dist/vue-ssr-client-manifest.json'))
  const bundle = _require(resolve('dist/vue-ssr-bundle.json'))
...
/* app.listen(...) will be called from layer0
