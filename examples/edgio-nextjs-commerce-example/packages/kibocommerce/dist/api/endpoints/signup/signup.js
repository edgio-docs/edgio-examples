...
const signup = async ({ req , res , body: { email , password , firstName , lastName  } , config , commerce ,  })=>{
    if (!(email && password)) {
    ...
    try {
        ...
        const accountId = (ref = registerUserResponse.data) === null || ref === void 0 ? void 0 : (ref1 = ref.account) === null || ref1 === void 0 ? void 0 : ref1.id;
        // Login user
        ...
        const authCookie = prepareSetCookie(config.customerCookie, JSON.stringify(token), token.accessTokenExpiration ? {
        ...
        if (error instanceof FetcherError && invalidCredentials.test(error.message)) {
