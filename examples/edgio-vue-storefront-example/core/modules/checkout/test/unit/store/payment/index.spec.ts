...
describe('Payment actions', () => {
  ...
  it('replaceMethods should replace payment method', async () => {
    ...
    expect(mockContext.dispatch).toHaveBeenCalledWith(
      'checkout/replacePaymentMethods',
      'example payment method',
      { root: true }
    )
  })
...
describe('Payment getters', () => {
  it('paymentMethods should return payment methods from rootStore', () => {
    const rootGetters = {
      'checkout/getPaymentMethods': [{ code: 'example payment method' }],
    }

    const personalDetails = (paymentModule.getters as any).paymentMethods(
      null,
      null,
      null,
      rootGetters
  ...
  it('getDefaultPaymentMethod should return default payment method from rootStore', () => {
    ...
    const personalDetails = (paymentModule.getters as any).getDefaultPaymentMethod(
      null,
      null,
      null,
      rootGetters
  ...
  it('getNotServerPaymentMethods should return not server methods from rootStore', () => {
    ...
    const personalDetails = (paymentModule.getters as any).getNotServerPaymentMethods(
      null,
      null,
      null,
      rootGetters
