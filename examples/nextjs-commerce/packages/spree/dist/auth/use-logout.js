...
import { ensureUserTokenResponse, removeUserTokenResponse } from '../utils/tokens/user-token-response';
...
export const handler = {
    ...
    async fetcher ({ input , options , fetch  }) {
        console.info('useLogout fetcher called. Configuration: ', 'input: ', input, 'options: ', options);
