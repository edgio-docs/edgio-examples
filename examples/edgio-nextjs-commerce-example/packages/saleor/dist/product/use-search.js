...
export const handler = {
    ...
    async fetcher ({ input , options , fetch  }) {
        ...
        if (categoryId) {
            var ref, ref1;
            edges = ((ref = data.collection) === null || ref === void 0 ? void 0 : (ref1 = ref.products) === null || ref1 === void 0 ? void 0 : ref1.edges) ?? [];
        ...
        // }
            ...
            var ref2;
            edges = ((ref2 = data.products) === null || ref2 === void 0 ? void 0 : ref2.edges) ?? [];
        }
        return {
