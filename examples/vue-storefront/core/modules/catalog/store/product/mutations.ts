...
const mutations: MutationTree<ProductState> = {
  ...
  [types.PRODUCT_SET_RELATED] (state, { key, items }) {
    state.related = Object.assign({}, state.related, { [key]: items })
  },
  ...
  [types.PRODUCT_SET_CUSTOM_OPTION] (state, { optionId, optionValue }) {
    state.current_custom_options = Object.assign({}, state.current_custom_options, {
      [optionId]: {
        option_id: optionId,
  ...
  [types.PRODUCT_SET_BUNDLE_OPTION] (state, { optionId, optionQty, optionSelections }) {
    ...
    state.current_bundle_options = Object.assign({}, state.current_bundle_options, {
      [optionId]: option
    })
  },
  [types.PRODUCT_SET_CUSTOM_OPTION_VALIDATOR] (state, { validationRule, validatorFunction }) {
    state.custom_options_validators = Object.assign({}, state.custom_options_validators, {
  ...
  [types.CATALOG_ADD_CUSTOM_OPTION_VALIDATOR] (state, { validationRule, validatorFunction }) {
    Logger.error(
      'Deprecated mutation CATALOG_ADD_CUSTOM_OPTION_VALIDATOR - use PRODUCT_SET_CUSTOM_OPTION_VALIDATOR instead'
    )()
  },
  ...
  [types.CATALOG_UPD_BUNDLE_OPTION] (state, { optionId, optionQty, optionSelections }) {
    Logger.error(
      'Deprecated mutation CATALOG_UPD_BUNDLE_OPTION - use PRODUCT_SET_BUNDLE_OPTION instead'
    )()
  },
  [types.CATALOG_UPD_PRODUCTS] (state, { products, append }) {
    Logger.error(
      'Deprecated mutation CATALOG_UPD_PRODUCTS - use PRODUCT_SET_PAGED_PRODUCTS or PRODUCT_ADD_PAGED_PRODUCTS instead'
    )()
  },
  [types.CATALOG_SET_PRODUCT_CURRENT] (state, product) {
    Logger.error(
      'Deprecated mutation CATALOG_SET_PRODUCT_CURRENT - use PRODUCT_SET_CURRENT instead'
    )()
  },
  [types.CATALOG_SET_PRODUCT_ORIGINAL] (state, product) {
    Logger.error(
      'Deprecated mutation CATALOG_SET_PRODUCT_ORIGINAL - use PRODUCT_SET_ORIGINAL instead'
    )()
  },
