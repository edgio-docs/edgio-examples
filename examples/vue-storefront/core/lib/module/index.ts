        ...
        this._c.store.modules.forEach(store => {
          if (doesStoreAlreadyExists(store.key, registeredModules)) {
            Logger.warn(
              'Error during "' +
                this._c.key +
                '" module registration! Store with key "' +
                store.key +
                '" already exists!',
              'module'
            )()
      ...
      if (areStoresUnique) {
        if (this._c.beforeRegistration) {
          if (this._c.beforeRegistration.length === 1) {
            ...
            Logger.warn(
              'You are using outdated signature for beforeRegistration hook that soon will be deprecated and module will stop working properly. Please update to the new signature that can be found in our docs: https://docs.vuestorefront.io/guide/modules/introduction.html#beforeregistration',
              'module',
              this._c.key
            )()
        ...
        if (this._c.afterRegistration) {
          if (this._c.afterRegistration.length === 1) {
            ...
            Logger.warn(
              'You are using outdated signature for afterRegistration hook that soon will be deprecated and module will stop working properly. Please update to the new signature that can be found in our docs: https://docs.vuestorefront.io/guide/modules/introduction.html#afterregistration',
              'module',
              this._c.key
            )()
