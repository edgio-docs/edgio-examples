...
class CookieHandler {
    ...
    async getAnonymousToken() {
        ...
        let anonymousAccessToken = response === null || response === void 0 ? void 0 : response.accessToken;
        return {
            response,
    ...
    isShopperCookieAnonymous() {
        ...
        const isAnonymous = (shopperSession === null || shopperSession === void 0 ? void 0 : shopperSession.customerAccount) ? false : true;
        return isAnonymous;
    }
    setAnonymousShopperCookie(anonymousShopperTokenResponse) {
        ...
        const authCookie = prepareSetCookie(this.config.customerCookie, JSON.stringify(anonymousShopperTokenResponse), (anonymousShopperTokenResponse === null || anonymousShopperTokenResponse === void 0 ? void 0 : anonymousShopperTokenResponse.accessTokenExpiration) ? {
...
export { CookieHandler as default };
