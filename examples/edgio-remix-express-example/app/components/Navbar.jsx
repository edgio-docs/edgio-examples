  ...
  return (
    <div className="flex flex-row flex-wrap items-center justify-between py-3 px-5">
      ...
      <div className="flex flex-row items-center space-x-4 py-1">
        <Prefetch url="/about">
          <Link to="/about" className="text-[#FFFFFF75]">
            About
          </Link>
        </Prefetch>
        <Prefetch url="/commerce">
          <Link to="/commerce" className="text-[#FFFFFF75]">
            Commerce
          </Link>
        </Prefetch>
        <a href="https://github.com/layer0-docs/layer0-remix-express-example" target="_blank">
