      ...
      if (validationRule) {
        ...
        if (typeof validator === 'function') {
          ...
          if (validationResult.error) {
            this.product.errors['custom_options_' + fieldName] = i18n.t(
              'Please configure product custom options and fix the validation errors'
            )
          } else {
          ...
          Logger.error(
            ...
            'components-product-custom-options'
          )()
