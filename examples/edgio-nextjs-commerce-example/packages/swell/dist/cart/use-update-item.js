    ...
    useHook: ({ fetch  })=>{
        return (ctx = {})=>{
            ...
            return useCallback(debounce(async (input)=>{
                ...
                const itemId = (item === null || item === void 0 ? void 0 : item.id) || firstLineItem.id;
                const productId = (item === null || item === void 0 ? void 0 : item.productId) || firstLineItem.productId;
                const variantId = (item === null || item === void 0 ? void 0 : item.variant.id) || firstLineItem.variant.id;
                if (!itemId || !productId) {
                    throw new ValidationError({
