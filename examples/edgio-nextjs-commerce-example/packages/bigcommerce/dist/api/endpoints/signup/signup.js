...
const signup = async ({ res , body: { firstName , lastName , email , password  } , config , commerce ,  })=>{
    ...
    try {
        ...
        if (error instanceof BigcommerceApiError && error.status === 422) {
            var ref;
            const hasEmailError = '0.email' in ((ref = error.data) === null || ref === void 0 ? void 0 : ref.errors);
