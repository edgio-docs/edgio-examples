export function formatCart(cart, lineItems) {
    ...
    return {
        ...
        currency: {
            code: ((ref4 = cart.FromUser) === null || ref4 === void 0 ? void 0 : (ref1 = ref4.xp) === null || ref1 === void 0 ? void 0 : ref1.currency) ?? 'USD'
        },
        ...
        lineItems: lineItems.map((lineItem)=>{
            ...
            return {
                ...
                variant: {
                    ...
                    name: lineItem.Product.Name,
                    image: {
                        url: (ref = lineItem.Product.xp) === null || ref === void 0 ? void 0 : (ref2 = ref.Images) === null || ref2 === void 0 ? void 0 : (ref3 = ref2[0]) === null || ref3 === void 0 ? void 0 : ref3.url
                    },
