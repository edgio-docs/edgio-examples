...
const addItem = async ({ req , res , body: { cartId , item  } , config ,  })=>{
    ...
    const productResponse = await config.fetch(getProductQuery, {
        variables: {
            productCode: item === null || item === void 0 ? void 0 : item.productId
        }
    });
    ...
    if (addToCartResponse.data.addItemToCurrentCart) {
        ...
        currentCart = result === null || result === void 0 ? void 0 : (ref = result.data) === null || ref === void 0 ? void 0 : ref.currentCart;
    }
    res.status(200).json({
