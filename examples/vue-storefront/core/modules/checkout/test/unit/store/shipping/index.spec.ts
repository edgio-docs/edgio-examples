...
describe('Shipping getters', () => {
  it('shippingMethods should return shipping methods from rootStore', () => {
    const rootGetters = {
      'checkout/getShippingMethods': [{ code: 'example shipping method' }],
    }

    const shippingDetails = (shippingModule.getters as any).shippingMethods(
      null,
      null,
      null,
      rootGetters
  ...
  it('getShippingMethods should return shipping methods from rootStore', () => {
    ...
    const shippingDetails = (shippingModule.getters as any).getShippingMethods(
      null,
      null,
      null,
      rootGetters
  ...
  it('getDefaultShippingMethod should return default shipping method from rootStore', () => {
    ...
    const personalDetails = (shippingModule.getters as any).getDefaultShippingMethod(
      null,
      null,
      null,
      rootGetters
