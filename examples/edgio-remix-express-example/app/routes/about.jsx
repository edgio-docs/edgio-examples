...
export const loader = async () => {
  const showcases = [
    `Layer0's Compatbility with Remix (Express)`,
    ...
    '(Free) Layer0 Image Optimization Service',
      ...
      <div className="mt-10 flex w-full max-w-2xl flex-col p-2.5">
        ...
        <div className="mt-5 flex flex-row items-center space-x-3 text-lg text-[#FFFFFF90]">
          ...
          <a
            ...
            href="https://github.com/layer0-docs/layer0-remix-express-example"
          >
            layer0-docs/layer0-remix-express-example
          </a>
        </div>
        <a className="mt-5" target="_blank" href="https://app.layer0.co/deploy?repo=https://github.com/layer0-docs/layer0-remix-express-example">
