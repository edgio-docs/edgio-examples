...
export const createSimpleProduct = (): Product => ({
  ...
  media_gallery: [
    { image: '/l/u/luma-yoga-brick.jpg', pos: 1, typ: 'image', lab: 'Image', vid: null },
  ],
  stock: {
    item_id: 21,
    product_id: 21,
  ...
  category: [
    { category_id: 3, name: 'Gear', slug: 'gear-3', path: 'gear/gear-3' },
    {
      ...
      path: 'gear/fitness-equipment/fitness-equipment-5',
    },
  ],
...
export const createGroupProduct = (): Product => ({
  ...
  regular_price: 0,
  description:
    '<p>Great set of Sprite Yoga Straps for every stretch and hold you need. There are three straps in this set: 6',
  ...
  media_gallery: [
    { image: '/l/u/luma-yoga-strap-set.jpg', pos: 1, typ: 'image', lab: 'Image', vid: null },
  ],
  category: [
    { category_id: 3, name: 'Gear', slug: 'gear-3', path: 'gear/gear-3' },
    {
...
export const createBundleProduct = (): Product => ({
  ...
  media_gallery: [
    { image: '/l/u/luma-yoga-kit-2.jpg', pos: 1, typ: 'image', lab: 'Image', vid: null },
  ],
  bundle_options: [
    {
      option_id: 1,
