  ...
  return (
    <div className="flex flex-row flex-wrap items-center justify-between py-3 px-5">
      ...
      <div className="flex flex-row items-center space-x-4 py-1">
        <Prefetch url="/page-data/about/page-data.json">
          <Link className="text-[#FFFFFF75]" to="/about">
            About
          </Link>
        </Prefetch>
        <Prefetch url="/page-data/commerce/page-data.json">
          <Link className="text-[#FFFFFF75]" to="/commerce">
            Commerce
          </Link>
        </Prefetch>
        <a href="https://github.com/layer0-docs/layer0-gatsby-example" target="_blank">
