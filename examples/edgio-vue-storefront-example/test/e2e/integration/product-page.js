...
describe('product page', () => {
  it('should verify that all information are visible', () => {
    ...
    cy.get('[aria-label="Select size M"]').click().should('have.class', 'active')
    cy.get('[data-testid=variantsLabel]').last().contains('M')
    cy.get('[aria-label="Select size L"]').click().should('have.class', 'active')
