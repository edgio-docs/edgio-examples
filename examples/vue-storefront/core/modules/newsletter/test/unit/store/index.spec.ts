...
describe('Newsletter actions', () => {
  ...
  describe('status', () => {
    it('should set e-mail and update newsletter status if it is subscribed', async () => {
      ...
      ;(NewsletterService.isSubscribed as any).mockImplementation(
        () => new Promise(resolve => resolve(isSubscribed))
      )
  ...
  describe('subscribe', () => {
    ...
    it('should subscribe if it is not subscribed', async () => {
      ...
      ;(NewsletterService.subscribe as any).mockImplementation(
  ...
  describe('unsubscribe', () => {
    ...
    it('should unsubscribe if it is subscribed', async () => {
      ...
      ;(NewsletterService.unsubscribe as any).mockImplementation(
        () => new Promise(resolve => resolve(true))
      )
