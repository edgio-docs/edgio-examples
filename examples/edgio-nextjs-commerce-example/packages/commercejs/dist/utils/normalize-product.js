    ...
    return variants === null || variants === void 0 ? void 0 : variants.map((variant)=>{
        return {
            ...
            options: Object.entries(variant.options).map(([variantGroupId, variantOptionId])=>{
                ...
                const valueLabel = (ref = variantGroupFromId === null || variantGroupFromId === void 0 ? void 0 : variantGroupFromId.options.find((option)=>option.id === variantOptionId
                )) === null || ref === void 0 ? void 0 : ref.name;
                return {
                    id: variantOptionId,
                    displayName: (variantGroupFromId === null || variantGroupFromId === void 0 ? void 0 : variantGroupFromId.name) || '',
