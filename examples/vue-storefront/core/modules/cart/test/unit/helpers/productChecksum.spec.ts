...
describe('Cart productChecksum', () => {
  it('returns checksum for bundle product', async () => {
    expect(productChecksum(bundleProduct)).toBe(
      '3e183f026489207a9cd535d20f141e07ddfea729af58a9088b82612f'
    )
  })

  it('returns checksum for configurable product', async () => {
    expect(productChecksum(configurableProduct)).toBe(
      '357e8f9f8918873f12ed993c3073ddd3e8980c933034b5e2fdab10b6'
    )
  })
})
