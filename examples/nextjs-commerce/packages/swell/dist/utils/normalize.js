...
const normalizeProductImages = (images)=>{
    ...
    return images === null || images === void 0 ? void 0 : images.map(({ file , ...rest })=>{
        return {
            url: (file === null || file === void 0 ? void 0 : file.url) + '',
            height: Number(file === null || file === void 0 ? void 0 : file.height),
            width: Number(file === null || file === void 0 ? void 0 : file.width),
            ...rest
        };
    });
};
const normalizeProductVariants = (variants, productOptions)=>{
    return variants === null || variants === void 0 ? void 0 : variants.map(({ id: id1 , name , price , option_value_ids: optionValueIds = []  })=>{
        ...
        const options = optionValueIds.map((id)=>{
            ...
            return normalizeProductOption({
                id,
                name: (matchingOption === null || matchingOption === void 0 ? void 0 : matchingOption.name) ?? '',
                values
            });
        });
        return {
...
export function normalizeCart({ id , account_id , date_created , currency , tax_included_total , items , sub_total , grand_total , discounts  }) {
    const cart = {
        ...
        lineItems: (items === null || items === void 0 ? void 0 : items.map(normalizeLineItem)) ?? [],
        lineItemsSubtotalPrice: +sub_total,
        subtotalPrice: +sub_total,
        totalPrice: grand_total,
        discounts: discounts === null || discounts === void 0 ? void 0 : discounts.map((discount)=>({
...
function normalizeLineItem({ id , product , price , variant , quantity  }) {
    const item = {
        ...
        variant: {
            ...
            image: {
                url: (product === null || product === void 0 ? void 0 : product.images) && product.images.length > 0 ? product === null || product === void 0 ? void 0 : product.images[0].file.url : '/'
            },
        ...
        options: [
            {
                value: variant === null || variant === void 0 ? void 0 : variant.name
            }, 
        ]
    };
    return item;
