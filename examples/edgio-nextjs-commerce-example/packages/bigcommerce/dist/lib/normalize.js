...
function normalizeProductOption(productOption) {
    ...
    return {
        id: entityId,
        values: edges === null || edges === void 0 ? void 0 : edges.map(({ node  })=>node
        ),
        ...rest
    };
}
export function normalizeProduct(productNode) {
    ...
    return update(productNode, {
        ...
        images: {
            $apply: ({ edges  })=>{
                return edges === null || edges === void 0 ? void 0 : edges.map(({ node: { urlOriginal , altText , ...rest }  })=>({
                        url: urlOriginal,
                        alt: altText,
                        ...rest
                    })
        ...
        variants: {
            $apply: ({ edges  })=>{
                return edges === null || edges === void 0 ? void 0 : edges.map(({ node: { entityId , productOptions , ...rest }  })=>{
                    return {
                        id: entityId,
                        options: (productOptions === null || productOptions === void 0 ? void 0 : productOptions.edges) ? productOptions.edges.map(normalizeProductOption) : [],
                        ...rest
                    };
                });
            }
        ...
        options: {
            $set: productOptions1.edges ? productOptions1 === null || productOptions1 === void 0 ? void 0 : productOptions1.edges.map(normalizeProductOption) : []
        },
        brand: {
            $apply: (brand)=>{
                return (brand === null || brand === void 0 ? void 0 : brand.entityId) ? brand === null || brand === void 0 ? void 0 : brand.entityId : null;
            }
        },
        slug: {
...
export function normalizeCart(data) {
    ...
    return {
        ...
        discounts: (ref = data.discounts) === null || ref === void 0 ? void 0 : ref.map((discount)=>({
