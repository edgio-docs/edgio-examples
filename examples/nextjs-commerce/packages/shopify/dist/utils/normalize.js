...
const normalizeProductImages = ({ edges  })=>{
    return edges === null || edges === void 0 ? void 0 : edges.map(({ node: { originalSrc: url , ...rest }  })=>({
            url,
            ...rest
        })
    );
...
const normalizeProductVariants = ({ edges  })=>{
    return edges === null || edges === void 0 ? void 0 : edges.map(({ node: { id , selectedOptions , sku , title , priceV2 , compareAtPriceV2 , requiresShipping , availableForSale ,  } ,  })=>{
        return {
            id,
            name: title,
            sku: sku ?? id,
...
export function normalizeCart(checkout) {
    ...
    return {
        ...
        currency: {
            code: (ref = checkout.totalPriceV2) === null || ref === void 0 ? void 0 : ref.currencyCode
        },
        taxesIncluded: checkout.taxesIncluded,
        lineItems: (ref1 = checkout.lineItems) === null || ref1 === void 0 ? void 0 : ref1.edges.map(normalizeLineItem),
        lineItemsSubtotalPrice: +((ref2 = checkout.subtotalPriceV2) === null || ref2 === void 0 ? void 0 : ref2.amount),
        subtotalPrice: +((ref3 = checkout.subtotalPriceV2) === null || ref3 === void 0 ? void 0 : ref3.amount),
        totalPrice: (ref4 = checkout.totalPriceV2) === null || ref4 === void 0 ? void 0 : ref4.amount,
        discounts: []
    };
}
function normalizeLineItem({ node: { id , title , variant , quantity  }  }) {
    ...
    return {
        ...
        variant: {
            ...
            image: {
                url: (variant === null || variant === void 0 ? void 0 : (ref = variant.image) === null || ref === void 0 ? void 0 : ref.originalSrc) || '/product-img-placeholder.svg'
            },
            requiresShipping: (variant === null || variant === void 0 ? void 0 : variant.requiresShipping) ?? false,
            price: variant === null || variant === void 0 ? void 0 : (ref5 = variant.priceV2) === null || ref5 === void 0 ? void 0 : ref5.amount,
            listPrice: variant === null || variant === void 0 ? void 0 : (ref6 = variant.compareAtPriceV2) === null || ref6 === void 0 ? void 0 : ref6.amount
        },
        path: String(variant === null || variant === void 0 ? void 0 : (ref7 = variant.product) === null || ref7 === void 0 ? void 0 : ref7.handle),
        discounts: [],
        options: (variant === null || variant === void 0 ? void 0 : variant.title) == 'Default Title' ? [] : variant === null || variant === void 0 ? void 0 : variant.selectedOptions
    };
}
...
export const normalizePages = (edges, locale)=>{
    return edges === null || edges === void 0 ? void 0 : edges.map((edge)=>normalizePage(edge.node, locale)
    );
};
