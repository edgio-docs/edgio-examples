...
export default function getPageOperation({ commerce  }) {
    async function getPage({ url , variables , config , preview  }) {
        ...
        const firstPage = (ref = data.documentListDocuments.items) === null || ref === void 0 ? void 0 : ref[0];
        const page = firstPage;
        if (preview || (page === null || page === void 0 ? void 0 : (ref1 = page.properties) === null || ref1 === void 0 ? void 0 : ref1.is_visible)) {
            return {
