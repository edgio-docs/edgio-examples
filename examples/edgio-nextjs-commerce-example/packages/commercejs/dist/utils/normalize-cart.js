const normalizeLineItem = (commercejsLineItem)=>{
    ...
    return {
        ...
        discounts: [],
        path: permalink,
        options: selected_options === null || selected_options === void 0 ? void 0 : selected_options.map(({ group_name , option_name  })=>({
                name: group_name,
                value: option_name
            })
        ),
        variant: {
            id: (variant === null || variant === void 0 ? void 0 : variant.id) ?? id,
            sku: (variant === null || variant === void 0 ? void 0 : variant.sku) ?? sku,
            name: product_name,
            requiresShipping: false,
            price: (variant === null || variant === void 0 ? void 0 : (ref = variant.price) === null || ref === void 0 ? void 0 : ref.raw) ?? price.raw,
            listPrice: (variant === null || variant === void 0 ? void 0 : (ref1 = variant.price) === null || ref1 === void 0 ? void 0 : ref1.raw) ?? price.raw,
            image: {
