        ...
        const useWrappedHook = (context)=>{
            ...
            return useMemo(()=>{
                return debounce(async (input)=>{
                    var ref, ref1, ref2;
                    const itemId = context === null || context === void 0 ? void 0 : (ref = context.item) === null || ref === void 0 ? void 0 : ref.id;
                    const productId = input.productId ?? (context === null || context === void 0 ? void 0 : (ref1 = context.item) === null || ref1 === void 0 ? void 0 : ref1.productId);
                    const variantId = input.variantId ?? (context === null || context === void 0 ? void 0 : (ref2 = context.item) === null || ref2 === void 0 ? void 0 : ref2.variantId);
                    ...
                    return data;
                }, (context === null || context === void 0 ? void 0 : context.wait) ?? 500);
            }, [
                mutate,
                context
            ]);
