...
var require_regexUtils = __commonJS({
  "node_modules/@edgio/core/utils/regexUtils.js"(exports2) {
    ...
    function getRegexGroupsCount(regex) {
      var _a;
      return (((_a = new RegExp(regex.toString() + "|").exec("")) === null || _a === void 0 ? void 0 : _a.length) || 1) - 1;
    }
    ...
    function bindRegexParams(destination, params) {
      var _a;
      return ((_a = destination.match(/(?<!\\)((?:\\{2})*)(\$[0-9]*)/g)) === null || _a === void 0 ? void 0 : _a.reduce((output, substitutionParam) => {
  ...
  "node_modules/@edgio/core/runtime/Backend.js"(exports2) {
    ...
    var Backend = class {
      ...
      getProxyRequestOptions(url, req, options = {}) {
        var _a, _b, _c;
        let agent = null;
        if (((_a = this.origin.tls_verify) === null || _a === void 0 ? void 0 : _a.allow_self_signed_certs) && url.protocol === "https:") {
    ...
    var OriginFetcher = class {
      ...
      async fetch(req, res, options, providedOriginName) {
        ...
        if (!(options === null || options === void 0 ? void 0 : options.followRedirects) || !res.getHeaders().location)
          return;
        if ((options === null || options === void 0 ? void 0 : options.followRedirects) && ((_a = options === null || options === void 0 ? void 0 : options.maxRedirects) !== null && _a !== void 0 ? _a : 0) <= 0) {
  ...
  "node_modules/@edgio/core/router/ParamsExtractor.js"(exports2) {
    ...
    var ParamsExtractor = class {
      ...
      extract(request) {
        var _a, _b;
        return {
          ...((_a = this.routeCriteria) === null || _a === void 0 ? void 0 : _a.path) ? ParamsExtractor.getMatchedPathParams(this.routeCriteria.path, request.path) : {},
    ...
    var RouteHelper = class {
      constructor(criteria, router) {
        ...
        this.serveStatic = (path, options = {}) => {
          ...
          this.rewritePath((_a = this.routeCriteria.path) !== null && _a !== void 0 ? _a : "/:path*", `${pathPrefix}/${path}`, true);
        };
        this.renderWithApp = () => {
        ...
        this.compute = (fn, isExclusive) => {
          ...
          this.sendToServerless(isExclusive ? constants_1.EDGIO_SERVERLESS_HINTS.computeExclusive : constants_1.EDGIO_SERVERLESS_HINTS.compute, index);
        };
...
var require_createMatchers = __commonJS({
  "node_modules/@edgio/core/router/createMatchers.js"(exports2) {
    ...
    function createMatchers(criteria) {
      ...
      if ((_a = criteria.response) === null || _a === void 0 ? void 0 : _a.statusCode) {
  ...
  "node_modules/@edgio/core/router/converters/toCacheManifestEntry.js"(exports2) {
    ...
    var serializeCriteriaValue = (criteria) => {
      ...
      if (criteria === void 0 || criteria === null) {
        ...
        return {
          value: (_a = serializeCriteriaValue(criteria.not)) === null || _a === void 0 ? void 0 : _a.value,
          isNot: true
        };
      } else {
    ...
    var toCacheManifestEntry = (criteria, features) => {
      var _a;
      const entry = {
        criteriaPath: criteria.path instanceof RegExp ? criteria.path.source : (_a = criteria.path) === null || _a === void 0 ? void 0 : _a.toString(),
