export default function getCustomerWishlistOperation({ commerce  }) {
    async function getCustomerWishlist({ config , variables , includeProducts  }) {
        ...
        if (includeProducts && (wishlist === null || wishlist === void 0 ? void 0 : (ref = wishlist.items) === null || ref === void 0 ? void 0 : ref.length)) {
            var ref1;
            const ids = (ref1 = wishlist.items) === null || ref1 === void 0 ? void 0 : ref1.map((item)=>{
                return (item === null || item === void 0 ? void 0 : item.product_id) ? String(item === null || item === void 0 ? void 0 : item.product_id) : null;
            }).filter((id)=>!!id
            );
