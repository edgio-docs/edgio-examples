const Home = () => {
  return (
    <>
      <section className="text-white text-center py-4 px-8">
        <p>
          This example uses Next.js 14 with the App router and is powered by
          Edgio v7.
        </p>
      </section>
      <div className="flex min-h-[calc(80vh-56px)] flex-col items-center justify-center px-5 md:px-0">
        <div className="flex w-full flex-row flex-wrap justify-center md:w-[700px]">
          ...
          <div className="flex w-[330px] flex-col items-start justify-start rounded p-5 md:w-1/2">
            ...
            <h3 className="mb-5 mt-2 text-lg text-[#FFFFFF75]">
              While most CDNs only cache content on your asset URLs, Edgio
              caches content on your page URLs using EdgeJS, allowing you to
              control caching within your application code.
            </h3>
            <a
              className="mt-auto text-[#01B18D] hover:underline"
          ...
          <div className="flex w-[330px] flex-col items-start justify-start rounded p-5 md:w-1/2">
            ...
            <h3 className="mt-2 text-lg text-[#FFFFFF75]">
              Edgio allows you to speed up the user’s browsing experience by
              deep fetching the assets referenced in the API response(s) that
              they are likely to be shown to the user.
            </h3>
            <a
              className="mt-auto text-[#01B18D] hover:underline"
