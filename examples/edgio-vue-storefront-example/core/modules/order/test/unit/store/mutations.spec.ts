...
describe('Order mutations', () => {
  ...
  describe('ORDER_ADD_SESSION_ORDER_HASH', () => {
    it('adds session order hash', () => {
      ...
      const expectedState = {
        session_order_hashes: ['session-order-hash'],
      }
      const wrapper = (mutations: any) =>
        mutations[types.ORDER_ADD_SESSION_ORDER_HASH](stateMock, session_order_hash)
  ...
  describe('ORDER_LAST_ORDER_WITH_CONFIRMATION', () => {
    it('adds last order with confirmation', () => {
      ...
      const wrapper = (mutations: any) =>
        mutations[types.ORDER_LAST_ORDER_WITH_CONFIRMATION](stateMock, order)
  ...
  describe('ORDER_REMOVE_SESSION_ORDER_HASH', () => {
    it('removes session order hash', () => {
      ...
      const expectedState = {
        session_order_hashes: ['session-order-hash-one', 'session-order-hash-three'],
      }
      const wrapper = (mutations: any) =>
        mutations[types.ORDER_REMOVE_SESSION_ORDER_HASH](stateMock, session_order_hash_two)
