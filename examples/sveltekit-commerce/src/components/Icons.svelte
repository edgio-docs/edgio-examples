...
<div>
  {#if type === 'star'}
    <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
      ><path d="M12.43 8L10 0L7.57 8H0L6.18 12.41L3.83 20L10 15.31L16.18 20L13.83 12.41L20 8H12.43Z" /></svg
    >
  {:else if type === 'cart'}
  ...
  {:else if type === 'minus'}
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
      ><path d="M5 12H19" stroke={strokeColor} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg
    >
  {:else if type === 'plus'}
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
      ><path d="M12 5V19" stroke={strokeColor} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path
        d="M5 12H19"
        stroke={strokeColor}
        stroke-width="1.5"
        stroke-linecap="round"
  ...
  {:else if type === 'arrowRight'}
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={strokeColor} xmlns="http://www.w3.org/2000/svg"
